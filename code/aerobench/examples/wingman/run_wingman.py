...
from aerobench.run_f16_sim import run_f16_sim, run_f16_sim_multistep
...
def main():
    ...
    res = run_f16_sim_multistep(init, tmax, ap, step=step, extended_states=extended_states, integrator_str='rk45')
